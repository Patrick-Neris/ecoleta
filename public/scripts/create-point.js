...
function getCities (event) {
    ...
    const url = `https://servicodados.ibge.gov.br/api/v1/localidades/estados/${ufValue}/regioes-imediatas`
...
//verificar se existem elementos selecionados, se sim pegar os itens selecionados
...
//se já tiver selecionado, 'desselecionar'
...
//se não tiver selecionado, selecionar
